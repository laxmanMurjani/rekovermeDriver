...
class _InviteFriendScreenState extends State<InviteFriendScreen> {
  ...
  Widget build(BuildContext context) {
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            child: Column(
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    String s =
                                        "Hey Checkout this app, Arby Ride \nUser - https://play.google.com/store/apps/details?id=com.recuvame.user\nProvider - https://play.google.com/store/apps/details?id=com.recuvame.driver.\nInstall this app with referral code ${cont.userData.value.referralUniqueId ?? ""}";
                                    FlutterShare.share(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                print("smdh");
                                String s =
                                    "Hey Checkout this app, Arby Ride User - https://play.google.com/store/apps/details?id=com.recuvame.user Provider - https://play.google.com/store/apps/details?id=com.recuvame.driver.\nInstall this app with referral code ${cont.userData.value.referralUniqueId ?? ""}";
                        ...
                        Container(
                          ...
                          // color: Colors.black45,
                          child: Text(
                            "get INR 100 in your Arby wallet for every friend you refer".tr,
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              color: Colors.black,
                              fontSize: 13.sp,
    ...
    //                               onTap: () {
    //                                 String s =
    //                                     "Hey Checkout this app, ETO Ride \nUser - https://play.google.com/store/apps/details?id=com.etom.user\nProvider - https://play.google.com/store/apps/details?id=com.recuvame.driver.\nInstall this app with referral code ${cont.userData.value.referralUniqueId ?? ""}";
    //                                 FlutterShare.share(
    //                                     title: "choose_one", text: s);
    //                               },
    //                               child: Container(
    ...
    //                             print("smdh");
    //                             String s =
    //                                 "Hey Checkout this app, ETO Ride User - https://play.google.com/store/apps/details?id=com.etom.user Provider - https://play.google.com/store/apps/details?id=com.recuvame.driver.\nInstall this app with referral code ${cont.userData.value.referralUniqueId ?? ""}";
    //
    //                             openWhatsapp(
    //                                 context: context,
    //                                 message:
