          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                //         Spacer(),
                //         Text(
                //           "${requestElement.request?.payment?.breakdown_amount=='null'? '0' :
                //           requestElement.request?.payment?.breakdown_amount} ${cont.homeActiveTripModel.value.currency ?? ""}",
                //           style: TextStyle(
                //               color: AppColors.primaryColor,
                //               fontSize: 13.sp,
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        requestElement.request?.paymentMode=='CASH'?
                        ...
                        Container(
                         ...
                         decoration: BoxDecoration(
                          ...
                          child: Text(
                            "${cont.homeActiveTripModel.value.currency ?? ""} ${requestElement.request?.payment?.total ?? "0"}",
                            style: TextStyle(
                  ...
                  requestElement.request!.payment!.breakdown_amount == "0" ?SizedBox() :   Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Spacer(),
                        Text(
                          "${cont.homeActiveTripModel.value.currency ?? ""} ${requestElement.request?.payment?.payable ?? "0"}",
                          style: TextStyle(
                              color: AppColors.primaryColor,
                              fontSize: 13.sp,
                              fontWeight: FontWeight.w600),
