...
class _AddTollChargeDialogState extends State<AddTollChargeDialog> {
  TextEditingController _tollTaxController = TextEditingController();
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        if (_tollTaxController.text.isEmpty) {
                        ...
                        if (int.tryParse(_tollTaxController.text)! >= 80) {
                          cont.showError(
                          ...
                          params["latitude"] = cont.userCurrentLocation!.latitude.toString();
                          params["longitude"] = cont.userCurrentLocation!.longitude.toString();
                          params["toll_price"] = "${_tollTaxController.text}";
                          cont.updateTrip(data: params);
                          Get.back();
                        }
                      },
