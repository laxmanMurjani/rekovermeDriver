...
class AppImage {
  ...
  static String messenger = "$_basePath/mensager.png";
  static String phone = "$_basePath/phone.png";
  static String moneyCash = "$_basePath/mony_cash.png";
  static String card = "$_basePath/card.png";
  static String speedCar = "$_basePath/speed_car.png";
  static String protect = "$_basePath/protect.png";
  static String boy = "$_basePath/boy.png";
  static String halfCar = "$_basePath/half_car.png";
  static String siren = "$_basePath/siren.png";
  ...
  static String onlineCar = "$_basePath/online_car.png";
  ...
  static String rekovermeDriverLogo = "$_basePath/rekoverme_driver_logo.jpg";
}
...
class AppColors {
  ...
  static const Color skyBlue = Color(0xffB3EEE8);
  static const Color primary = Color(0xff002744);
  static const Color primaryColor = Color(0xff000000);
  static const Color primaryColor2 = Color(0xff974ffb);
  static const Color backgroundColor = Color(0xffe4e2e3);
